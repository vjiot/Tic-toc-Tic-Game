 ...
 **********************************************/
    ...
    void new_game(){
        ...
        send(serverSock, player_name1, sizeof(player_name1), 0);
 ...
 **********************************************/
    ...
    void rec_data(){
        ...
        if (result == '2' ){
                gotoxy(0,5);
                printf("Player 1 Symbol - (x) Name - %s",buffer);
                gotoxy(y,x);
                name_wait = '1';
                result = '3';
                mode = 0;
 ...
 **********************************************/
    ...
    int server_setup(){
           ...
           do{
                connect_status = connect(serverSock, (SOCKADDR *)&addr, sizeof(addr));
               // gotoxy(35,35);
...
void board_design()
{
    ...
    printf("Player 2 Symbol - (0) Name - %s \n(Wait Until Player 1 is login)\n\n",player_name1);
